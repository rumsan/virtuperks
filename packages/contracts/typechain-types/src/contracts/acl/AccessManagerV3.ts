...
export interface AccessManagerV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "PUBLIC_ROLE"
...
export interface AccessManagerV3 extends BaseContract {
  connect(runner?: ContractRunner | null): AccessManagerV3;
  waitForDeployment(): Promise<this>;

  interface: AccessManagerV3Interface;
