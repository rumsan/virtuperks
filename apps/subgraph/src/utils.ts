...
export function fetchTaskDetails(
  ...
  if (!taskDetail) {
    ...
    taskDetail.detailsUrl = task.getDetailsUrl();
    taskDetail.owner = task.getOwner();
    taskDetail.expiryDate = task.getExpiryDate();
    taskDetail.rewardToken = task.getRewardToken();
    taskDetail.totalRewardAmount = task.getTotalRewardAmount();
    taskDetail.isOpen = task.getIsOpen();
    taskDetail.requireApproval = task.getRequireApproval();
    taskDetail.isWhitelisted = task.getIsWhitelisted();
    taskDetail.isTokenDisbursed = task.getIsTokenDisbursed();
    taskDetail.maxParticipants = task.getMaxParticipants();
    taskDetail.acceptedParticipantCount = task.getAcceptedParticipantCount();
